      ...
      <div className="container">
        ...
        <div className="strip-carousel" {...dragGuard.bind()}>
          <Swiper
            ...
            /* freeMode: drag tới đâu giữ tới đó, không snap về slide nguyên.
               sticky:false → không có lực hút về snap point;
               momentum:true → có quán tính khi thả → cảm giác native. */
            freeMode={{
              enabled: true,
              sticky: false,
              momentum: true,
